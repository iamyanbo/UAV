...
class TrajectoryBundle:
    ...
    def load(self, record):
        ...
        allowed_teachers={'observed_frontier_local_expert','observed-depth-motion-demonstrations/v6'}
...
def save_checkpoint(path, model, critic, optimizer, scheduler, update, best, rng, bundle):
    ...
    state.update(module=bundle.module,objective_version=objective_version(bundle.module),
        action_semantics='post-safety-dispatch/50ms-v3',belief_version='shared-droid-local-depth/v4',teacher_version='observed-depth-motion-demonstrations/v6',
