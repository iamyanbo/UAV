...
The original research and literature documents are preserved here with their original dates and wording. They are historical research notes, not claims that the current implementation meets navigation acceptance.
...
The active learning-loop implementation and evidence are in [research/rgb_flight](../../research/rgb_flight/). Large simulator assets, RGB archives and checkpoints remain in the existing study workspace; repository manifests and receipts retain their identities.
